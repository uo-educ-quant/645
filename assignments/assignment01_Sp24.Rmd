...
2. Analytic sample description (40%)
    + Produce a summary statistics table (Table 1), including median and interquartile range (IQR) for participant age, mean and standard deviation (SD) for and count variables, and the proportion of the sample with each level of each dichotomous/categorical variable.
