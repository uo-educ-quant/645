...
3. Methods and analysis (60%)
    + Model the relationship between physical activity and depression symptoms using a logistic regression model.
      ...
      + Check for critical assumptions and outliers of the best-fitting model. Produce and interpret a **plot of the linearity of the relationship between age (a continuous covariate) and the log odds of the depression outcome (Figure 1)**.
