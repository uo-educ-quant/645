...
Define and calculate person-time variable and understand its purpose in Poisson regression.
...
-	Describe and write the regression model for Poisson regression.
...
-	Understand the use of the offset variable.
