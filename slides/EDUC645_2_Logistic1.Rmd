...
- Unit 2 quiz available Friday 5/3 and due by 11:59 PM on Monday 5/6.
...
NHANES_data0910 <- NHANES_data0910 %>% 
  filter(Age >= 20) %>% 
...
NHANES_data0910_imp <- mice(NHANES_data0910, method = "cart", m = 20, maxit = 10)
```
