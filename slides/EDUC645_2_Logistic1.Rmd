...
--
- *Note:* Sometimes a standard linear regression model is used for dichotomous outcomes. This approach is called a *linear probability model (LPM)*, and some argue its interpretation is more straightforward than logistic regression. It does, however, violate several key assumptions of linear regression.
