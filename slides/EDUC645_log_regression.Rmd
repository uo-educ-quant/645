...
The maximum likelihood estimation (MLE) is a general class of method in statistics that is used to estimate the model parameters
...
•	Visually show how the maximum likelihood estimator works 
o	iterates over local maxima
o	show a contour plot
