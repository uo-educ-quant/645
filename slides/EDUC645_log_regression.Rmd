...
[insert pros/cons, comparison between the two approaches]
...
$p = probability_{event}$: Probability of a given event
...
$$\color{lightgreen}{Y_i}=\beta_0 + \beta_1 x_i + \varepsilon_{i}$$

--

$$\color{lightgreen}{Y_i} = \color{lightblue}{\log(\frac{p_i}{1-p_i})}$$

Becomes...
--

$$\color{lightblue}{\log(\frac{p_i}{1-p_i})}=\beta_0 + \beta_1 x_i +  \varepsilon_i$$
...
$${\log(\frac{p_i}{1-p_i})}=\beta_0 + \beta_1 x_i +  \varepsilon_i$$
...
##  sbtract the maximum from the log likelihood function.
