...
author: Mark A. Hammond
date: "Spring 2022"

email: "mhammon5@uoregon.edu"
#web: ""
...
Students should be weary of skipping class. 
...
Students must read the following before class session.  Important: class readings are subject to change, contingent on mitigating circumstances and the progress we make as a class.  Students are encouraged to attend lectures and check the course website for updates. 
...
## `r advdate(mon, 1)`: Reviewing GLM and Introduction to Logistic Regression
Required:
* BMLR 
  - Ch. 2 (pp. xx-xx)
  - 6-6.4 (pp. xx-xx)
...
* BMLR 
  - 
  - 3.3 'Discrete Random Variables' (pp. xx-xx)
  
##  `r advdate(mon, 2)`: Logistic Regression
Required:
* BMLR 
  - 6.5-6.7 (pp. xx-xx)
...
##  `r advdate(mon, 3)`: Logistic Regression
Required:
* BMLR 
  - (pp. xx-xx)
...
##  `r advdate(mon, 4)`: Introduction to Count Data and Poisson Regression
Required:
* BMLR 
  - 4-4.4 (pp. xx-xx)
...
##  `r advdate(mon, 5)`: Poisson Regression
Required:
* BMLR 
  - 4.5-4.10 (pp. xx-xx)
  - All of Ch. 5 (pp. xx-xx)

Recommended:

##  `r advdate(mon, 6)`: Nested Data
Required:
* BMLR 
  - 8-8.5 (pp. xx-xx)
...
##  `r advdate(mon, 9)`: Measurement Error and Reliability
Required:
* BMLR 
  - 7-7.8 (pp. xx-xx)
