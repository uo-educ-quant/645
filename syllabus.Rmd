...
1. Articulate 
  2. Distinguish between fitting a logistic regression and poisson regression differ from fitting a linear least squares regression model
  3. Conduct and interpret (orally and in writing) regression analyses with dichotomous and count outcomes and predictors
  4. Describe the assumptions of logistic and poisson regression analysis and test analytic models for the extent to which they satisfy these assumptions
...
7. Recognize when response variables and covariates have been collected at multiple (nested) levels 
8. Analyze continuous and discrete outcomes using multilevel model, including cases in which covariates are continuous, categorical, or centered.
9. Understand and measure inter-dependency of observed data
10. Analyse patterns of missing data and apply modern methods for treating missingness of data in the GLM framework.
11. Use the R programming language to conduct all such analyses.
