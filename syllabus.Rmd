...
Instructor: {full name and pronouns}  
Contact Information: {email, phone, office location, office hours, preferred method of contact}  
GTF name: {full name and pronouns}  
GTF Contact Information: {email, phone, office location, office hours, preferred method of contact}  

# II. Course Overview
This course is the third in a sequence intended to provide a toolkit of statistical concepts, methods, and their implementation to producers of applied research in education, human services, and other social sciences. The course is organized around the principle that research design depends in part on researchers’ substantive questions and their quantitative data available to address these questions. In this upper-level introductory course, students will learn about and practice using analytic models and strategies that are suitable for examining data that have (a) a nested structure, (b) a dichotomous outcome variable, (c) a count outcome variable, and (d) missing values; they will also learn about when and how to estimate (e) internal consistency and interrater reliability for research purposes. The course seeks to blend a conceptual, mathematical, and applied understanding of introductory statistical concepts. At the core of our pedagogical approach is the belief that students learn statistical analysis by doing statistical analysis. EDUC 643 (or a similar intermediate statistics course) is a pre-requisite as is a basic familiarity with a statistical programming language (preferably R).   

# III. Student Learning Outcomes
By the end of this term, it is expected that students will be able to:  

1. Determine when it is appropriate to use multilevel modeling, logistic regression, and Poisson regression in education and human services.  
2. Conduct and interpret basic multilevel, logistic, and Poisson, and multilevel regression analyses.  
3. Describe the assumptions of multilevel, logistic, and Poisson, and multilevel regression analyses and test analytic models for the extent to which they satisfy the models’ assumptions.  
4. Explain and apply the concepts of reliability and agreement in measurement for research purposes.   
5. Explain the applications and limitations of different methods for treating missing data.  
6. Implement modern methods for examining and treating missingness of data in the GLM framework.  
...
Albano, A. D. (2020). Introduction to educational and psychological measurement using R. https://www.thetaminusb.com/intro-measurement-r/ 

We will primarily be referring to chapters in Roback and Legler’s [Beyond Multiple Linear Regression ](https://bookdown.org/roback/bookdown-BeyondMLR/) (**BMLR**). We will also rely on a couple of chapters in Albano’s [Introduction to Educational and Psychological Measurement Using R](https://www.thetaminusb.com/intro-measurement-r/) (**IEPM**) Both textbooks are available for free online. You may choose to purchase a paper copy of BMLR if you wish, but it is not required.
...
# IV. Weekly Schedule of Topics and Assignments and Readings 
...
# XIII. Accessible Education - (see https://aec.uoregon.edu/best-practices-faculty for more information) 
...
This UO webpage includes resources for food, housing, healthcare, childcare, transportation, technology, finances, and legal support: https://blogs.uoregon.edu/basicneeds/food/  If your need is urgent, please contact the Care and Advocacy Program by calling 541-346-3216, filling out the Community Care and Support form, or by scheduling an appointment with an advocate.  
...
# XVII. Academic Integrity - You can find faculty resources on academic misconduct here: https://dos.uoregon.edu/faculty-resources 
