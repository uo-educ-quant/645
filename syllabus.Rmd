...
1. Distinguish between fitting a logistic and Poisson regression, and understand how they differ from fitting a linear least squares regression model.
2. Conduct and interpret (orally and written) regression analyses with dichotomous and count outcomes and predictors.
3. Describe the assumptions of logistic and poisson regression analysis and test analytic models for the extent to which they satisfy these assumptions.
4. Generalize the logistic and Poisson regression models (conceptually and in practice) to predictors that are categorical, interacted and non-linear.
5. Build taxonomies of sensible logistic and Poisson regression models in response to independently developed research questions.
6. Recognize when response variables and covariates have been collected at multiple (nested) levels.
...
8. Understand and measure inter-dependency of observed data.
9. Analyse patterns of missing data and apply modern methods for treating missingness of data in the GLM framework.
10. Use the R programming language to conduct all aforementioned analyses.
