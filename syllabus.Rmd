...
8. CTT reliability, inter-rater consistency/agreement ICCs, g-theory (which encompasses ICCs), and item difficulty and discrimination. 
9. Analyze assessment data using classical-test-theory reliability, generalizability theory, and item analysis.
10. Apply modern methods for treating missingness of data in the GLM framework.
11. Use the R programming language to conduct analyses throughout the course.
