...
**EDUC 645: Applied Statistics in Education and Human Services III (3 credits) - Spring 2023 (36574)**
...
* Claire Zhang (she/her/hers); Email: congliz@uoregon.edu (preferred); Office: Lokey Ed 102J; Office hour: by appointment

* Havisha (Havi) Khurana (she/her/hers); Email: havishak@uoregon.edu (preferred); Office: Lokey Ed 111; Office hour: by appointment
...
2. Conduct and interpret basic logistic and Poisson regression analyses and analyses for nested data.
...
The due dates for course assignments and the final are posted [here](./assignments.html). A maximum of 75% credit will be earned for work submitted up to 3 days late; assignments more than 3 days late will be given no credit. 
...
## Quizzes
Five classes will begin with a very short multiple-choice quiz that is designed to test your knowledge of the theoretical principles underlying the statistics we are studying for the week. Quizzes will be open book and notes.

## Assignments
The goal of the assignments is to practice the concepts and vocabulary we have been modeling in class and implement some of the techniques we have learned. Each assignment has an associated data source, short codebook and detailed instructions for the required data and analytic tasks. You may work on your own or with up to two (2) partners. If you choose to work with others, please make sure that you engage in a full, fair, and mutually-agreeable collaboration. Plan, execute, and write-up your analyses together; do not simply divide up the work. Further assignment details are available [here](./assignments.html). Assignments will be evaluated based on students’ performance in completing the assignment tasks, showing their work, and in demonstrating their understanding of the course concepts and terminology.
